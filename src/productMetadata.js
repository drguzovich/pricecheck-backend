...
function normaliseOpenFoodFactsProduct(barcode, payload) {
...
async function getProductMetadata(barcode) {
  ...
  try {
    ...
    return normaliseOpenFoodFactsProduct(barcode, payload);
  } catch (error) {
...
module.exports = { getProductMetadata, normaliseOpenFoodFactsProduct };
